<template>
    <div class="main">
        ...
        <!-- section 1 start -->
        <section class="page-header-section ptb-100 banner-img">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-8">
                        <div class="section-heading text-center mb-5">
                            ...
                            <p>Distinctively grow go forward manufactured products and optimal networks.
                                Enthusiastically
                                ...
                                <div class="staff-member">
                                    ...
                                    <div class="overlay d-flex align-items-center justify-content-center">
                                        <div class="overlay-inner">
                                            <p class="teacher-quote">"Energistically administrate multifunctional rather
                                                than front-end expertise." </p><a href="#" class="teacher-name">
                                    ...
                                    <div class="overlay d-flex align-items-center justify-content-center">
                                        <div class="overlay-inner">
                                            <p class="teacher-quote">"Conveniently whiteboard one-to-one bandwidth
                                                rather than revolutionary mindshare." </p><a href="#"
                                                class="teacher-name">
