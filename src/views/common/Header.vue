        ...
        <div id="logoAndNav" class="main-header-menu-wrap white-bg border-bottom">
            <div class="container">
                <nav class="js-mega-menu navbar navbar-expand-md header-nav">
                    ...
                    <!--logo start-->
                    <a class="navbar-brand" href="index.html"><img src="@/assets/img/logo-color.png" width="120"
                            ...
                            <div class="row">
                                <div class="col-md-9 col-lg-8">
                                    <div class="hero-content-wrap text-white position-relative z-index">
                                        ...
                                        <p class="lead">Synergistically leverage existing robust best practices whereas
                                            integrated manufactured products. Intrinsicly evisculate value-added.</p>
                                        <ul class="list-unstyled tech-feature-list text-white">
                                            <li class="py-1"><span class="ti-control-forward mr-2"></span>Flexible, Easy
                                            ...
                                            <li class="py-1"><span
                                                ...
                                                Sub Domains, FTP Accounts</li>
                                            <li class="py-1"><span
                                                    class="ti-control-forward mr-2"></span><strong>99%</strong> Uptime
                                                Guarantee</li>
                                            <li class="py-1"><span
                                                    class="ti-control-forward mr-2"></span><strong>45-Day</strong>
                                                Money-Back Guarantee</li>
